...
const sampleItems = [
  {
    name: "iPhone 14 Pro",
    description:
      "Latest Apple iPhone with advanced camera system and A16 Bionic chip",
    price: 999.99,
  ...
  },
  {
    ...
    description:
      "Flagship Android smartphone with excellent camera and performance",
    price: 899.99,
    category: "electronics",
    stock: 30,
  ...
  },
  {
    name: "MacBook Air M2",
    description:
      "Lightweight laptop with Apple M2 chip and all-day battery life",
    price: 1199.99,
    category: "electronics",
    stock: 25,
  ...
  },
  {
    ...
    description:
      "Professional tennis racket for intermediate to advanced players",
    price: 179.99,
    category: "sports",
    stock: 40,
